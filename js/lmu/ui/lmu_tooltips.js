const TOOLTIP_DATA = {
    ...
    'graph_df': {
        title: 'Downforce',
        desc: 'Aerodynamic load generated by wings and bodywork.',
        inc: 'Significantly improves high-speed stability and cornering grip.',
        dec: 'Increases theoretical top speed but reduces high-speed grip.'
    },
    'graph_grip': {
        title: 'Grip',
        desc: 'Overall traction potential from tires and aero.',
        inc: 'Increases cornering speeds, braking potential, and acceleration out of slow corners.',
        dec: 'Reduces cornering loads. Low grip makes the car slide more.'
    },
    'graph_turnin': {
        title: 'Turn-in',
        desc: 'Initial steering response and agility when entering corners.',
        inc: 'Quicker direction changes. Makes the car feel dartier and more responsive.',
        dec: 'Slower changes of direction. Car feels more sluggish but more stable.'
    },
    'graph_bumps': {
        title: 'Bumps',
        desc: 'Suspension absorption rating.',
        inc: 'Better bump absorption improves lap consistency and stability on rough tracks or high kerbs.',
        dec: 'A stiffer car will bounce more over uneven surfaces, potentially losing traction.'
    },
    'graph_ts': {
        title: 'Top Speed',
        desc: 'Theoretical maximum velocity on long straights.',
        inc: 'Allows the car to reach higher speeds before hitting the rev limiter or aero drag wall.',
        dec: 'Better acceleration but lower peak speed on long straights. Good for tight tracks.'
    }
};
...
function initTooltipsExtra() {
    ...
    document.querySelectorAll('.info-icon-btn, .graph-tooltip-trigger').forEach(btn => {
